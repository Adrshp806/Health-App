...
# create logger
logger = logging.getLogger("data_preparation_cancer")
...
if __name__ == "__main__":
    ...
    # data load path
    data_path = root_path / "data/processed/processed_heart_disease.csv"
    # save data directory
    save_data_dir = root_path / "data" / "interim" / "heart_processed"

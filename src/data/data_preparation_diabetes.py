...
# create logger
logger = logging.getLogger("data_preparation_diabetes")
...
if __name__ == "__main__":
    ...
    # data load path
    data_path = root_path / "data" / "processed" / "diabetes_cleanned.csv"
    # save data directory
    save_data_dir = root_path / "data" / "interim" / "diabetes_processed"

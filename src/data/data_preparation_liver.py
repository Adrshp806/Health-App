...
# create logger
logger = logging.getLogger("data_preparation_liver")
...
if __name__ == "__main__":
    ...
    # data load path
    data_path = root_path / "data" / "processed" / "processed_liver_data.csv"
    # save data directory
    save_data_dir = root_path / "data" / "interim" / "liver_processed"

...
# create logger
logger = logging.getLogger("data_preparation_kidney")
...
if __name__ == "__main__":
    ...
    # data load path
    data_path = root_path / "data" / "processed" / "kidney_cleanned.csv"
    # save data directory
    save_data_dir = root_path / "data" / "interim" / "kidney_processed"
